    ...
    <div class="container mt-4 animate-fade-in">
        ...
        <c:if test="${order.status != 'PENDING'}">
            <div class="alert alert-warning mt-4 animate__animated animate__fadeIn">
                ...
                <a href="${pageContext.request.contextPath}/order/history" class="alert-link">
        ...
        <c:if test="${order.status == 'PENDING'}">
            <form action="${pageContext.request.contextPath}/order/update" method="post" class="mt-4" id="editForm">
