        ...
        <div class="login-container">
            ...
            <form action="adminlogin" method="post">
                ...
                <div class="forgot-password text-center mt-3">
                    <a href="adminforgetpassword.jsp" style="color: var(--primary-color); font-weight: bold; text-decoration: none; display: inline-flex; align-items: center; gap: 5px;">
            ...
            <div class="register-link text-center mt-4">
                <a href="adminregister.jsp" style="color: var(--secondary-color); font-weight: bold; font-size: 1.1em; text-decoration: none; display: inline-flex; align-items: center; gap: 8px;">
